            ...
            <div class="modal-body">
                <form id="bookingForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="selectEmployees" name="selectEmployees" required>
...
<script>
    ...
    function saveBooking() {
        ...
        if (!formData.get('date') || !formData.get('time') || !formData.get('name') || !formData.get('phone') || !formData.get('serviceType') || !formData.get('service') || !formData.get('selectEmployees')) {
            Swal.fire({
        ...
        Swal.fire({
            ...
            window.location.href = "payment.php"; // เปลี่ยนไปยังหน้า payment.php
        });
    }
</script>
