...
<head>
    ...
    <!-- jquery -->
    <script type="text/javascript" src="../employee/index_employee.js"></script>
    ...
    <div class="container2">
        ...
        <div class="container2">
            <ul class="nav justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../employee/aboutEmployee.php">เกี่ยวกับเรา</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../employee/reservationEmployee.php">ตารางพนักงาน</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../employee/productEmployee.php">สินค้าและบริการ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../employee/promotionEmployee.php">โปรโมชั่น</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../employee/resultEmployee.php">ผลลัพธ์ลูกค้า</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../employee/contactEmployee.php">ติดต่อเรา</a>
                </li>
            </ul>
        </div>
        ...
        <div class="profileEmployee">
            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist" style="margin-top: 20px;">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-employee-tab" data-bs-toggle="pill" data-bs-target="#pills-employee" type="button" role="tab" aria-controls="pills-employee" aria-selected="false">ตารางงาน</button>
                </li>
            </ul>
