...
<div class="container1">
            ...
            <div class="row align-items-center">
                <div class="col mr-3">
                    <div class="card" style="width: 20rem;">
                        <img src="images/haman.svg" class="card-img-top" alt="..." style="width:100%; height:auto;">
                        <div class="card-body">
    ...
    <div class="product">
        ...
        <p class="text-start fs-3">สินค้า</p>
            ...
            <a class="btn btn-primary" href="#" role="button" style="margin-top: 30px;">สมัครสมาชิกใหม่ >></a>
